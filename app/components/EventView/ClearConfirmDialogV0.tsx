...
export type ClearConfirmDialogV0Type = "participants" | "groups"

type ClearConfirmDialogV0Props = {
  open: boolean
  onOpenChange: (open: boolean) => void
  onConfirm: () => void | Promise<void>
  type: ClearConfirmDialogV0Type
}

export function ClearConfirmDialogV0({
  open,
  onOpenChange,
  onConfirm,
  type,
}: ClearConfirmDialogV0Props) {
